...
const PERFORMANCE = {
  "7d": {
    ...
    outcomes: [
      ...
      { label: "3x+", count: 127, rate: 21.13 },
      { label: "5x+", count: 67, rate: 11.15 },
      { label: "10x+", count: 26, rate: 4.33 },
      { label: "25x+", count: 6, rate: 1.00 },
      { label: "50x+", count: 4, rate: 0.67 },
    ],
    topCalls: [
      { symbol: "$BalledEagle", multiple: 234.80, entry: 3897, high: 915010 },
      { symbol: "$chair", multiple: 120.30, entry: 7206, high: 866855 },
      { symbol: "$MACRODUCK", multiple: 102.58, entry: 58841, high: 6035709 },
    ],
  },
  "30d": {
    label: "30D",
    ...
    outcomes: [
      ...
      { label: "3x+", count: 281, rate: 18.75 },
      { label: "5x+", count: 135, rate: 9.01 },
      { label: "10x+", count: 52, rate: 3.47 },
      { label: "25x+", count: 14, rate: 0.93 },
      { label: "50x+", count: 8, rate: 0.53 },
    ],
    topCalls: [
      { symbol: "$BalledEagle", multiple: 234.80, entry: 3897, high: 915010 },
